                ...
                <tbody>
                  <?php $no=0; foreach ($Kritik_saran as $komen) {?>
                    <tr>
                      ...
                      <td class="text-right">
                        <button data-toggle="modal" data-target="#exampleModal<?php echo $komen->id_kritik_saran?>" class="btn btn-simple btn-danger btn-icon edit"><i class="material-icons">delete</i></button>
                      </td>
                    </tr>
                  <?php } ?>  
                </tbody>
