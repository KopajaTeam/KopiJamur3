                                ...
                                <div class="card-content invoice-relative-content">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6 l8">
                                            ...
                                            <img src="assets/images/ignature.png" class="invoice-signature m-t-md" alt="">
                                        </div>
                                        <div class="col s12 m6 l4 right-align">
                                            <div class="text-right">
                                                ...
                                                <h6 class="m-t-sm light-blue-text"><b>Shipping</b></h6>
                                                <h5 class="">$240</h5>
                                                <div class="divider"></div>
                                                <h6 class="m-t-md text-success light-blue-text"><b>Total</b></h6>
                                                <h4 class="text-success">$7522</h4>
                                                <div class="divider"></div>
                                                <a class="waves-effect waves-light btn teal">Submit your invoice</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
