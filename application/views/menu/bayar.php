			...
			<div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
				...
				<div class="flex-w flex-sb bo10 p-t-15 p-b-20">
					...
					<div class="w-size20 w-full-sm">
						...
						<span class="s-text19">
							Pilih daerah unutk menentukan ongkos kirim
						</span>
						...
						<div class="rs2-select2 rs3-select2 rs4-select2 bo4 of-hidden w-size21 m-t-8 m-b-12">
							<select class="selection-2" name="country">
								...
								<option>Baratan</option>
							</select>
						</div>

						<div class="size13 bo4 m-b-12">
						<input class="sizefull s-text7 p-l-15 p-r-15" type="text" name="state" placeholder="Desa">
						</div>
				...
				<label for="exampleInputFile">Silakan transfer pembayaran pada rekening (XXXXXXXX) Bank X, Atas Nama Kopi Jamur Prestasi</label>
                  ...
                  <p class="help-block">Terimakasih Telah Membeli Produk Kami</p>
