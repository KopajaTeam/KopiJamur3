<div class="col-sm-3">
	...
	<ul class="list-group">
		...
		<a href="<?php echo base_url('Dashboard_user/pesanan_saya')?>" class="list-group-item" style="color: #323232"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Pesanan Saya <span class="badge">13</span></a>
		<a href="<?php echo base_url('Dashboard_user/testimonial_view')?>" class="list-group-item"><i class="fa fa-star" aria-hidden="true"></i> Testimonial Saya<span class="badge">6</span> </a>
		<a href="<?php echo base_url('Dashboard_user/forum_view')?>" class="list-group-item"><i class="fa fa-comments" aria-hidden="true"></i> Forum Saya<span class="badge">6</span></a>
